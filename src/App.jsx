    ...
    <div className="min-h-screen" style={{ backgroundColor: "#eef2ff" }}>
      ...
      <nav className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3"><span className="text-2xl">⚡</span><span className="font-bold text-gray-900">Build A Daily Habit Tracker App With A</span></div>
